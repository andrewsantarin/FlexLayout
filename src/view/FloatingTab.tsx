...
/** @hidden @internal */
export class FloatingTab extends React.Component<IFloatingTabProps, any> {

    constructor(props:IFloatingTabProps) {
        super(props);
    ...
    componentWillReceiveProps(newProps: IFloatingTabProps) {
    ...
    render() {
        ...
        let style:JSMap<any> = node._styleWithoutPosition({
